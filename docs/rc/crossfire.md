---
title: TBS Crossfire
description: "Нотатки про TBS Crossfire: підключення GPS до Nano RX, телеметрія, TBS Agent, частоти, hop sequence, режими RACE та логіка uplink/downlink."
tags: [rc, crossfire, tbs, lrs, telemetry]
comments: true
---
