...
* **Label Model** — якщо вибрати цю опцію, відобразяться всі налаштовані мітки, які можна буде вибрати для цієї моделі. Більше інформації про [Model Labels](select-model.md#model-labels) наведено нижче.
