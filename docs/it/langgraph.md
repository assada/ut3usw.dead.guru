...
LangGraph — це бібліотека оркестрації, побудована поверх LangChain (з використанням [LCEL](https://python.langchain.com/docs/concepts/lcel/)), яка дозволяє створювати складні робочі потоки (графи). Вона ідеально підходить для створення агентів із циклічними процесами, умовною логікою та гнучким контролем потоків виконання. LangGraph легко інтегрується з усіма компонентами LangChain, доповнюючи його додатковими можливостями.
...
Хочу зазначити що платформа не обов`язкова. Ви можете ПОВНІСТЮ ігнорувати її існування і використовувати LangGraph або LangChain без неї.
...
А що далі? Далі творіть. Відкривайте файл графу, подивіться на tools.py, оцініть системний промпт. Далі ви можете використовуючи CLI langgraph згенерувати docker файли і запустити сервер у продакшені!
