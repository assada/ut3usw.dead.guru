---
title: LangGraph
description: "Нотатки про LangGraph українською: що це таке, графи станів, агенти, LangChain, швидкий старт, платформа, обмеження і практичні думки."
comments: true
---
...
![Схема екосистеми LangChain і LangGraph](./img/langchain.svg)
