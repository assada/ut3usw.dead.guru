...
description: Роздуми про skills, роль інструкцій для агентів, автоматизацію робочих процесів і те, коли спеціальні навички справді потрібні.
authors: ut3usw
tags: [ai, openai, erlang, lean]
comments: true
---

![Ілюстрація до нотатки про skills](./img/fv.jpg)
